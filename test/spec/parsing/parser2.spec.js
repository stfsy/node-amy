...
describe('Parser2', () => {
    ...
    describe('.parseLine', () => {
        ...
        it('should also return add operation', () => {
            const operations = parser.parseLine('@amy import abc/def.html with abc.d.e.f.g as amy and include abc.html with def')
            ...
            expect(operations[2].name()).to.equal('as')
            expect(operations[2].arguments()).to.equal('amy')
            expect(operations[3].name()).to.equal('include')
